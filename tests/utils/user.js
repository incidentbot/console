...
function signUpNewUser(page, name, email, password) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          _a.sent();
          return [4 /*yield*/, page.getByPlaceholder('Full Name').fill(name)];
        case 2:
          _a.sent();
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            page.getByPlaceholder('Repeat Password').fill(password),
          ];
        case 5:
          _a.sent();
          return [
...
function logInUser(page, email, password) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
