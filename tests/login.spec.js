...
const fillForm = (page, email, password) =>
...
;(0, test_1.test)("Log In button is visible", (_a) =>
  __awaiter(void 0, [_a], void 0, function (_b) {
    const page = _b.page
    return __generator(this, (_c) => {
      switch (_c.label) {
...
;(0, test_1.test)("Forgot Password link is visible", (_a) =>
  __awaiter(void 0, [_a], void 0, function (_b) {
    const page = _b.page
    return __generator(this, (_c) => {
      switch (_c.label) {
...
;(0, test_1.test)("Log in with valid email and password ", (_a) =>
  __awaiter(void 0, [_a], void 0, function (_b) {
    const page = _b.page
    return __generator(this, (_c) => {
      switch (_c.label) {
...
;(0, test_1.test)("Log in with invalid email", (_a) =>
  __awaiter(void 0, [_a], void 0, function (_b) {
    const page = _b.page
    return __generator(this, (_c) => {
      switch (_c.label) {
...
;(0, test_1.test)("Log in with invalid password", (_a) =>
  __awaiter(void 0, [_a], void 0, function (_b) {
    let password
    const page = _b.page
    return __generator(this, (_c) => {
...
// Log out
;(0, test_1.test)("Successful log out", (_a) =>
  __awaiter(void 0, [_a], void 0, function (_b) {
    const page = _b.page
    return __generator(this, (_c) => {
      switch (_c.label) {
...
;(0, test_1.test)("Logged-out user cannot access protected routes", (_a) =>
  __awaiter(void 0, [_a], void 0, function (_b) {
    const page = _b.page
    return __generator(this, (_c) => {
      switch (_c.label) {
